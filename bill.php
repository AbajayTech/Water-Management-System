                            ...
                            <header>
                                <div class="row">
                                    ...
                                    <div class="col company-details">
                                        ...
                                        <div>245,01001,NAIROBI KENYA</div>
                                        <div>(254)723456789</div>
                                        <div>Negust@gmail.com</div>
                                    </div>
                                </div>
                            </header>
                            <main>
                                <div class="row contacts">
                                    <div class="col invoice-to">
                                        ...
                                        <div class="email"><a style="color:black"
                                                href="tel: <?php echo $customer_phone?>">
                                ...
                                <table>
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td> <?php echo $total; $tax = $total * 0.05 // 5% of total ?> KSH</td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td colspan="2"></td>
                                            <td colspan="2">TAX 5%</td>
                                            <td><?php echo $tax; ?> KSH</td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td colspan="2"></td>
                                            <td colspan="2">GRAND TOTAL</td>
                                            <td><?php echo $total+$tax ;?> KSH</td>
                                        </tr>
